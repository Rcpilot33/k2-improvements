...
MACRO_LAYOUT = (
    ...
    ("A16_CARTO_SELECT_ORCA_01_COOL", "Smooth Cool Plate (Orca)", "#1AED07"),
    ("A16_CARTO_SELECT_ORCA_02_ENGINEERING", "Engineering Plate (Orca)", "#1AED07"),
    ("A16_CARTO_SELECT_ORCA_03_HIGH_TEMP", "Smooth High Temp Plate (Orca)", "#1AED07"),
    ("A16_CARTO_SELECT_ORCA_04_TEXTURED_PEI", "Textured PEI Plate (Orca)", "#1AED07"),
    ("A16_CARTO_SELECT_ORCA_05_TEXTURED_COOL", "Textured Cool Plate (Orca)", "#1AED07"),
    ("A16_CARTO_SELECT_ORCA_06_SUPERTACK", "Cool Plate (SuperTack) (Orca)", "#1AED07"),
