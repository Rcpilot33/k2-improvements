...
echo "    OrcaSlicer templates:"
echo "      slicer-templates/orca-start-material-only.gcode"
echo "      slicer-templates/orca-start-material-kamp.gcode"
echo "      slicer-templates/orca-start-material-surface-profiles.gcode"
echo "      slicer-templates/orca-start-material-surface-profiles-kamp.gcode"
echo ""
