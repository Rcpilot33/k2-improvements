...
echo "      slicer-templates/creality-print-material-machine-start.gcode"
echo "      slicer-templates/creality-print-plate-selection-machine-start.gcode"
echo "      slicer-templates/creality-print-kamp-machine-start.gcode"
echo "      slicer-templates/creality-print-kamp-and-plate-selection-machine-start.gcode"
